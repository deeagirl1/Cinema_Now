...
public class ComplaintServiceMockTest {
    ...
    public void setUp()
    {
        ...
        List<Complaint> complaints = List.of(
                new Complaint("1","test","test","test")
        );


//        when(complaintDAL.("1")).thenReturn(appUsers.get(0));
//        when(complaintDAL.deleteUser("1")).thenReturn(true);
    ...
    public void getAllComplaintsTest()
    {
        ...
        //assert
        Assertions.assertEquals("test", complaints.get(0).getContainer());
    }
    ...
    public void createComplaintTest()
    {
        ...
        Assertions.assertEquals(complaintDTO.getSender_id(), captureAppUser.getId());

package nl.fontys.Cinema_Now.filter;
...
public class CustomAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    @Autowired
    public CustomAuthenticationFilter(AuthenticationManager manager, UserService userService)
    {
...
//        response.setHeader("refresh_token",refresh_token);
        String username = userService.getUser(user.getUsername()).getUsername();
...
//        response.setContentType(APPLICATION_JSON_VALUE);
//        new ObjectMapper().writeValue(response.getOutputStream(),"Username or password are invalid please try again!");
//    }
}
